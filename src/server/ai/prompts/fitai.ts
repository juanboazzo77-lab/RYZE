...
/**
 * Prompt de sistema del AI Coach de GYMO. Persona + guardrails de seguridad.
...
export function goalAdviceSystemPrompt(locale: Locale, contextBlock: string): string {
  return `Sos el AI Coach de GYMO. El usuario no sabe qué objetivo elegir. Con sus
...
export function physiqueAnalysisSystemPrompt(locale: Locale, contextBlock: string): string {
  return `Sos el AI Coach de GYMO analizando fotos de físico que el usuario mandó
...
export function mealPlanSystemPrompt(
  ...
  return `Sos el AI Coach de GYMO armando un día de comidas para el usuario.
...
export function coachSystemPrompt(locale: Locale, contextBlock: string): string {
  return `Sos el AI Coach de GYMO: un entrenador y guía de nutrición cercano, concreto y
...
export function planSystemPrompt(locale: Locale, contextBlock: string): string {
  return `Sos el generador de planes de GYMO. Diseñás una rutina de entrenamiento de
...
export function checkinSystemPrompt(locale: Locale, contextBlock: string): string {
  return `Sos el AI Coach de GYMO haciendo la revisión semanal del usuario. Mirás cómo
...
export function nutritionSystemPrompt(locale: Locale, contextBlock: string): string {
  return `Sos el generador de objetivos nutricionales de GYMO. A partir del perfil,
