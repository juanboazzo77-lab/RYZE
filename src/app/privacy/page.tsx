...
export const metadata: Metadata = { title: 'Política de Privacidad · FitAI' };
...
export default function PrivacyPage() {
  return (
    <div className="mx-auto min-h-screen max-w-2xl px-4 py-10">
      ...
      <h1 className="mt-4 text-2xl font-bold tracking-tight">Política de Privacidad de FitAI</h1>
      <p className="mt-1 text-xs text-muted-foreground">Última actualización: {LAST_UPDATED}</p>

      <P>
        Esta política explica qué datos recopila FitAI (&ldquo;la app&rdquo;, &ldquo;nosotros&rdquo;),
      ...
      <P>
        Responsable del tratamiento de datos: Juan Boazzo, operando FitAI como desarrollador
      ...
      <P>
        ...
        pago procesa cada proveedor (Stripe, Google Play Billing o Apple, según corresponda); FitAI
      ...
      <ul className="list-disc space-y-1 pl-5">
        ...
        <Li>
          ...
          esa consulta puntual; las fotos nunca quedan guardadas del lado de FitAI.
        </Li>
        <Li>
      ...
      <P>
        ...
        propiedad de FitAI o de terceros.
      </P>
      ...
      <P>
        FitAI no está pensada para menores de 13 años. Si sos menor de edad según las leyes de tu
